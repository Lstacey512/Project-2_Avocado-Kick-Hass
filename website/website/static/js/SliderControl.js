L.Control.SliderControl = L.Control.extend({
    ...
    startSlider: function () {
            ...
            slide: function (e, ui) {
                ...
                if (!!_options.markers[ui.value]) {
                    ...
                    if (_options.markers[ui.value].feature !== undefined) {
                        if (_options.markers[ui.value].feature.properties.report[_options.timeAttribute]) {
                            if (_options.markers[ui.value]) $('#slider-timestamp').html(
                                _extractTimestamp(_options.markers[ui.value].feature.properties.report[_options.timeAttribute], _options));
                        } else {
        ...
        if (!_options.range && _options.alwaysShowDate) {
            $('#slider-timestamp').html(_extractTimeStamp(_options.markers[index_start].feature.properties.report[_options.timeAttribute], _options));
        }
